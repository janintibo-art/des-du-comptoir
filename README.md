...
sur chaque case. **Économie** en place : argent (1500 au départ), **achat de propriétés**, **loyers** (gares/services/couleurs), Départ +200, **Chance/Caisse** (vos textes), **prison**, **faillite**. À venir : maisons/hôtels et réseau.
