...
P.mount=function(parent, cfg){ P.cfg=cfg; P.PH=P.PW*(966/1274);
  ...
  const cam=new BABYLON.ArcRotateCamera('c',Math.PI/2,1.48,P.PH*1.7,new BABYLON.Vector3(0,0,0),sc);
  cam.setPosition(new BABYLON.Vector3(0, 1.2, P.PH*1.75)); cam.setTarget(new BABYLON.Vector3(0,0,0));
  cam.attachControl(cv,true); cam.lowerBetaLimit=0.55; cam.upperBetaLimit=1.54; cam.lowerRadiusLimit=P.PH*1.0; cam.upperRadiusLimit=P.PH*2.6;
